...
package com.openmobilehub.android.auth.plugin.common.mobileweb.data.login.datasource
...
interface AuthDataSource<AuthTokenResponseType> {
    ...
    companion object {
        ...
        /**
         * Default format for the redirect URI.
         * This can be overridden by implementations if needed.
         */
        const val REDIRECT_FORMAT: String = "%s:/oauth2redirect"
    }
}
