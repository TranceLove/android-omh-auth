...
package com.openmobilehub.android.auth.plugin.dropbox.mobileweb.presentation
...
import com.openmobilehub.android.auth.plugin.dropbox.mobileweb.presentation.redirect.RedirectActivity

/**
 * Dropbox Sign-In (via mobile web) implementation of the OmhAuthClient abstraction
 */
class DropboxMobileWebAuthClient private constructor(
    ...
    class Builder(
        ...
        override fun build(context: Context): OmhAuthClient {
            return DropboxMobileWebAuthClient(clientId, authScope, context)
        }
    }
    ...
    override fun getProviderSdk(): Any {
        throw UnsupportedOperationException(
            "getProviderSdk() is not supported for Dropbox Sign-In over Mobile Web."
        )
    }
}
