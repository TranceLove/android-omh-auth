...
package com.openmobilehub.android.auth.plugin.dropbox.mobileweb.data.login.datasource
...
internal class DropboxAuthDataSource(
    ...
    override suspend fun requestToken(
        ...
        val retval = authService.getToken(
            clientId = clientId,
            code = authCode,
    ...
    companion object {
        ...
        fun formatRedirectUri(context: Context): String {
            val scheme = context.getString(
                R.string.com_openmobilehub_android_auth_dropbox_oauth2_redirect_scheme
            )
            val host = context.getString(
                R.string.com_openmobilehub_android_auth_dropbox_oauth2_redirect_host
            )
            val pathPrefix = context.getString(
                R.string.com_openmobilehub_android_auth_dropbox_oauth2_redirect_pathPrefix
            )
