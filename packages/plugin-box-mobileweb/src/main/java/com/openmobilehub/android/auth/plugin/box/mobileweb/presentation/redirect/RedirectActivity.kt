...
package com.openmobilehub.android.auth.plugin.box.mobileweb.presentation.redirect
...
class RedirectActivity : RedirectActivity() {
    ...
    override val viewModel: RedirectViewModel by viewModels {
        ViewModelFactory(
            requireNotNull(intent.getStringExtra(CLIENT_ID)),
            requireNotNull(intent.getStringExtra(CLIENT_SECRET)))
    }
