...
package com.openmobilehub.android.auth.plugin.box.mobileweb.data.user.datasource
...
internal class BoxUserDataSource(private val sharedPreferences: SharedPreferences) :
    ...
    override suspend fun handleIdToken(idToken: String, clientId: String) {
        requireNotNull<String>(sharedPreferences.getString(ACCESS_TOKEN, null)).let { accessToken ->
