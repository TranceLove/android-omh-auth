...
package com.openmobilehub.android.auth.plugin.box.mobileweb.data.login.datasource
...
import com.openmobilehub.android.auth.plugin.box.mobileweb.R
...
internal class BoxAuthDataSource(
    ...
    companion object {
        ...
        fun formatRedirectUri(context: Context): String {
            val scheme = context.getString(R.string.com_openmobilehub_android_auth_box_oauth2_redirect_scheme)
            val host = context.getString(R.string.com_openmobilehub_android_auth_box_oauth2_redirect_host)
            val pathPrefix = context.getString(R.string.com_openmobilehub_android_auth_box_oauth2_redirect_pathPrefix)
